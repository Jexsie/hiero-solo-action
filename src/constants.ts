...
export const WGET_DOWNLOAD_URL = "https://github.com/userdocs/qbt-workflow-files/releases/latest/download/wget";

export const JAVA_VERSION = "21.0.6";
export const JAVA_DOWNLOAD_URL = "https://api.adoptium.net/v3/binary/latest/21/ga/linux/x64/jdk/hotspot/normal/eclipse?project=jdk";
